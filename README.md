# 🚀 React-MasterClass
This repository contains all tutorial work from  **Jonas Schmedtmann’s** Master Modern React course.

---
# 📚 Modules & Projects
--- 
## ⭐ 03 - A First Look at React
- **Overview:** A quick intro into Pure React.  A minimal, framework-free React setup using the React and ReactDOM UMD CDN scripts. Instead of using bundlers or build tools like Vite, Webpack, or Create React App, this example runs React directly in the browser inside a single HTML file.

## ⭐ 05 - Thinking in React (Pizza Menu) 🍕
- **Overview:** A multi-component pizza menu app using the "Thinking in React" workflow, focusing on breaking the UI into reusable components. Practiced props, conditional rendering, and mapping dynamic data to the UI.
